package ua.nure.kn.prymasiuk.usermanagement;
...
public class UserTest {
    private final static String FIRST_NAME = "Viktoriya";
    private final static String LAST_NAME = "Prymasiuk";
...
//        Date dateOfBirth = calendar.getTime();
     ...
     *
     * THIS TEST IS ACTUAL ONLY TILL THE END OF 2018
     *
     * Expected result: AGE
     */
    @Test
